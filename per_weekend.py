...
import csv
import sailors_scraper
import full_scores_scraper
import re
...
def main(scores_url, sailors_url, csv_file='weekend_results.csv'):
	output_matrix = []
	sailors_matrix = sailors_scraper.sailors_matrix(sailors_url)
	scores_matrix = full_scores_scraper.scores_matrix(scores_url)
